      ...
      <div className="grow max-w-7xl mx-auto px-4 py-6 md:py-10 md:px-8 pb-24 w-full">
        ...
        {loading ? (
          <div className="space-y-4 animate-pulse">
            ...
            <div className="hidden lg:grid grid-cols-6 gap-4 p-5 bg-gray-200/60 dark:bg-white/5 rounded-t-[24px]">
              {[...Array(6)].map((_, i) => (
                <div key={i} className="h-4 bg-gray-300 dark:bg-gray-700 rounded-md w-2/3"></div>
              ))}
            </div>
            ...
            <div className="space-y-3">
              {[...Array(5)].map((_, rowIndex) => (
                <div 
                  key={rowIndex} 
                  className="p-5 border border-gray-100 dark:border-white/10 rounded-2xl bg-white dark:bg-white/5 grid grid-cols-1 lg:grid-cols-6 gap-4 items-center"
                >
                  {/* Student Column */}
                  ...
                  {/* Purpose Reference */}
                  <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-md w-32 hidden lg:block"></div>
                  {/* TxID */}
                  <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-md w-28 hidden lg:block"></div>
                  {/* Timestamp */}
                  <div className="h-4 bg-gray-200 dark:bg-gray-700 rounded-md w-20 hidden lg:block"></div>
                  {/* Verification Status */}
                  <div className="h-6 bg-gray-200 dark:bg-gray-700 rounded-full w-16"></div>
                  {/* Amount Value */}
                  <div className="h-5 bg-gray-200 dark:bg-gray-700 rounded-md w-20 lg:text-right ml-auto lg:ml-0"></div>
                </div>
              ))}
            </div>
            <p className="text-xs text-center font-medium text-gray-400 dark:text-gray-500 mt-4">
              Extracting live transaction logs data sheets...
            </p>
          </div>
        ) : payments.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-20 text-center border-2 border-dashed rounded-3xl p-6 md:p-15 dark:border-white/10 bg-white dark:bg-white/5 border-gray-200">
          ...
          <>
            {/* 📱 MOBILE & TABLET LAYOUT: Card Grid View */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:hidden mb-6">
              {payments.map((pay) => (
                <div
                  key={pay.id || pay.transactionId}
            ...
            {/* 💻 DESKTOP LAYOUT: Full Scale Table */}
            <div className="hidden lg:block overflow-hidden rounded-[24px] border dark:border-white/10 border-gray-100 dark:bg-white/5 bg-white shadow-sm">
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse text-sm">
                  <thead>
