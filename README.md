...
* **Professional UI:** Modern Purple-themed interface with **Glassmorphism** effects.
* **Fully Responsive:** Optimized for Mobile, Tablet, and Desktop screens.
* **Role-Based Access:** Personalized views for Admins and Developers.
* **Interactive Navigation:** Smooth sidebar integration and a sticky, blurred navbar for premium UX.
...
* **API Management:** Axios / Custom API Services
